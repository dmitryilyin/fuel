...
class mcollective::rabbitmq (
  ...
  exec { 'create-mcollective-directed-exchange':
    ...
    tries     => 10,
    try_sleep => 3,
    unless    => "curl -I http://localhost:${management_port}/api/exchanges/${actual_vhost}/mcollective_directed",
  }
  ...
  exec { 'create-mcollective-broadcast-exchange':
    ...
    tries     => 10,
    try_sleep => 3,
    unless    => "curl -I http://localhost:${management_port}/api/exchanges/${actual_vhost}/mcollective_broadcast",
  }
